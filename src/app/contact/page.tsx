            ...
            <div className="rounded-card border border-slate-200 bg-slate-50 p-6">
              ...
              <ul className="mt-5 space-y-4">
                ...
                <li className="flex items-center gap-3 text-sm text-slate-600">
                  <Phone className="h-5 w-5 shrink-0 text-orange-500" aria-hidden />
                  <a href={`tel:${siteConfig.phone}`} className="hover:text-navy-900">
                    {siteConfig.phone}
                  </a>
                </li>
                <li className="flex items-center gap-3 text-sm text-slate-600">
                  <Mail className="h-5 w-5 shrink-0 text-orange-500" aria-hidden />
                  <a href={`mailto:${siteConfig.email}`} className="hover:text-navy-900">
                    {siteConfig.email}
                  </a>
                </li>
              </ul>
