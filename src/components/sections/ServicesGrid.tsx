...
export function ServiceCard({ service }: { service: ServiceItem }) {
  ...
  return (
    <Card id={service.slug} className="flex h-full scroll-mt-24 flex-col">
      <span className="flex h-11 w-11 items-center justify-center rounded-control bg-gradient-to-br from-navy-800 to-navy-600 text-orange-300 shadow-sm transition-transform duration-300 group-hover/card:scale-110 group-hover/card:rotate-3">
      ...
      <div className="mt-5 flex items-center justify-between border-t border-slate-100 pt-4">
        <span className="text-sm font-semibold text-navy-900">Learn more</span>
